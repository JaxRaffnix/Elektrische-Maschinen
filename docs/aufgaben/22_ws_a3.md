...
Um die Flusskennline zu bestimmen, wird die fremderregte Maschine im Leerlauf mit $n_{0,\text{mess}} = 2000 \,\text{min}^{-1}$ betrieben, dies entspricht *keinen* Nennbetriebspunkt. Dabei wird die Quellenspannung $U_q$ in Abhängigkeit vom Erregerstrom $I_f$ bestimmt. Die Messdaten können durch folgende Funktion angenähert werden, wenn im Bogenmaß gerechnet wird:
